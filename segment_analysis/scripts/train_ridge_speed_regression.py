#!/usr/bin/env python3
"""Cross-validated ridge regression for cleaned GPX segment speed."""
...
CV_RESULTS = ROOT / "data" / "ridge_speed_cv_results.csv"
CV_PREDICTIONS = ROOT / "data" / "ridge_speed_cv_predictions.csv"
COEFFICIENTS = ROOT / "data" / "ridge_speed_coefficients.csv"
...
def main() -> int:
    ...
    for alpha in ALPHAS:
        ...
        cv_rows.append({"alpha": alpha, "rmse_mph": round(rmse, 4), "mae_mph": round(mae, 4), "r2": round(r2, 4)})
    ...
    write_csv(CV_RESULTS, cv_rows, ["alpha", "rmse_mph", "mae_mph", "r2"])
    write_csv(
        CV_PREDICTIONS,
        [
            {
